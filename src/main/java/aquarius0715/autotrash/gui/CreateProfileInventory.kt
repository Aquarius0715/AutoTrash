...
class CreateProfileInventory(private val plugin: AutoTrash) {
    ...
    var profileInv = Bukkit.createInventory(null, 54, "${ChatColor.AQUA}${ChatColor.BOLD}プロファイル選択画面")
    ...
    fun createProfileInventoryLook(profile: Int, player: Player) {
        ...
        confirmButtonMeta.setDisplayName("${ChatColor.GREEN}${ChatColor.BOLD}ここをクリックしてこのプロファイルを選択する。")

        confirmButton.itemMeta = confirmButtonMeta

        denialButtonMeta.setDisplayName("${ChatColor.RED}${ChatColor.BOLD}ここをクリックして前のページに戻る。")
    ...
    private fun putButton(profile: Int, index: Int) {
        ...
        lore.add("${ChatColor.GREEN}${ChatColor.BOLD}左クリック${ChatColor.WHITE}${ChatColor.BOLD}: プロファイルを${ChatColor.YELLOW}${ChatColor.BOLD}確認・選択")

        lore.add("${ChatColor.RED}${ChatColor.BOLD}右クリック${ChatColor.WHITE}${ChatColor.BOLD}: プロファイルを${ChatColor.YELLOW}${ChatColor.BOLD}変更。")

        lore.add("${ChatColor.LIGHT_PURPLE}${ChatColor.BOLD}SHIFT + クリック${ChatColor.WHITE}${ChatColor.BOLD}: プロファイルを${ChatColor.YELLOW}${ChatColor.BOLD}選択")
